...
export default class App extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('http://lff-production.linxnote.club/api_check_task_status', {
            method: 'POST',
            headers: {
            ...
            .then((jsonData) => { 
                fetch('http://lff-production.linxnote.club/api_achievement_list_processing', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    ...
                    .catch((err) => {
                        console.log('錯誤: Food_Processing ', err);
                    })
            })
            .catch((err) => {
                                ...
                                this.state.get_list.map((val, index) => {
                                    ...
                                    return (
                                        ...
                                        <TouchableOpacity key={index} onPress={() => this.props.navigation.navigate('Detail'
                                            , { val: val, user: this.state.user,  display: 'Display_Btn_Look_Post_Processing' }
                                        )
